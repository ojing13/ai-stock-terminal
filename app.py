        ...
        with tab4:
            ...
            if st.button("원클릭 종합 분석 리포트 생성"):
                with st.spinner('모든 데이터를 종합하여 분석하는 중입니다...'):
                    ...
                    **주의: 동일한 재무 데이터, 주가 위치, 최신 동향이 주어지면 항상 동일한 점수를 도출하도록 감정을 철저히 배제하고 아래 기준표에 따라 기계적으로 계산하세요.**

                    1. [SCORE: 0~100] (AI 투자의견) — 아래 항목 점수를 합산
                    ※ 각 항목을 수치로 판단하여 해당 점수를 더하세요. 자의적 해석 금지.
                    - Forward PER < 8: +18점 / 8~12: +13점 / 12~20: +7점 / 20~30: +2점 / 30 이상: 0점
                    - Trailing PER 대비 Forward PER 괴리율 (저평가 신호): Forward PER이 Trailing PER보다 40% 이상 낮음: +12점 / 20~40% 낮음: +7점 / 20% 미만 차이: +2점 / Forward PER이 더 높음: 0점
                    - PBR < 1.0 (자산 대비 저평가): +10점 / 1.0~1.5: +6점 / 1.5~3.0: +3점 / 3.0 이상: 0점
                    - 부채비율 < 50%: +10점 / 50~100%: +7점 / 100~200%: +3점 / 200% 이상: 0점
                    - 영업이익률 > 20%: +12점 / 10~20%: +8점 / 0~10%: +3점 / 적자: 0점
                    - 현재가가 52주 최고가 대비 20% 이상 하락: +12점 / 10~20% 하락: +7점 / 10% 미만: +2점
                    - 기업 비즈니스 모델 경쟁력(AI 자체 판단 - 해당 산업 내 독점/과점 여부, 진입장벽, 기술력): 강함 +12점 / 보통 +6점 / 약함 0점
                    - 매출 성장률 > 15%: +8점 / 5~15%: +5점 / 0~5%: +2점 / 마이너스: 0점
                    - 배당수익률 > 3%: +6점 / 1~3%: +3점 / 1% 미만: +1점
                    → 합산 후 최종 SCORE 확정 (0~100 범위 내)

                    2. [RISK: 0~100] (리스크 지수) — 아래 항목 점수를 합산
                    ※ 위험 요소가 많을수록 높은 점수. 수치 기준으로만 판단.
                    - 부채비율 > 200%: +25점 / 100~200%: +15점 / 50~100%: +8점 / 50% 미만: 0점
                    - Trailing PER > 30: +20점 / 20~30: +12점 / 10~20: +5점 / 10 미만: 0점
                    - 52주 최고가 대비 현재가 하락폭 < 5% (고점 근처): +20점 / 5~15%: +12점 / 15~30%: +5점 / 30% 이상: 0점
                    - 기업 구조적 리스크(AI 자체 판단 - 산업 사이클, 경쟁 심화, 기술 대체 위험 등): 높음 +20점 / 중간 +10점 / 낮음 0점
                    - 영업이익 적자 또는 적자 전환: +15점 / 흑자이나 감소 추세: +8점 / 안정적 흑자: 0점
                    → 합산 후 최종 RISK 확정 (0~100 범위 내)

                    3. [RETURN: 0~100] (기대수익 지수) — 아래 항목 점수를 합산
                    ※ 상승 잠재력이 클수록 높은 점수. 수치 기준으로만 판단.
                    - Forward PER < 8: +22점 / 8~12: +16점 / 12~20: +8점 / 20~30: +2점 / 30 이상: 0점
                    - Trailing PER 대비 Forward PER 괴리율 (이익 급증 기대): 40% 이상 낮음: +18점 / 20~40% 낮음: +10점 / 20% 미만: +3점 / Forward PER이 더 높음: 0점
                    - PBR < 1.0 (순자산 대비 저평가, 하방 안전마진): +15점 / 1.0~1.5: +9점 / 1.5~3.0: +4점 / 3.0 이상: 0점
                    - 52주 최고가 대비 현재가 20% 이상 하락 (반등 여력): +15점 / 10~20%: +9점 / 10% 미만: +2점
                    - 매출 성장률 > 20%: +15점 / 10~20%: +10점 / 0~10%: +4점 / 마이너스: 0점
                    - 기업 미래 성장 동력(AI 자체 판단 - 신사업, 기술 경쟁력, 시장 확장성): 강함 +15점 / 중간 +8점 / 약함 0점
                    → 합산 후 최종 RETURN 확정 (0~100 범위 내)
                    """
                    try:
                        response = client.models.generate_content(
                            model='gemini-2.5-flash', contents=prompt, config={"temperature": 0.0}
