            ...
            if st.button("원클릭 종합 분석 리포트 생성"):
                with st.spinner('모든 데이터를 종합하여 분석하는 중입니다...'):
                    ...
                    **주의: 동일한 재무 데이터, 주가 위치, 최신 동향이 주어지면 항상 동일한 점수를 도출하도록 감정을 철저히 배제하고 아래 기준표에 따라 기계적으로 계산하세요.**
                    ...
                    - Forward PER < 10: +20점 / 10~15: +12점 / 15~25: +5점 / 25 이상: 0점
                    - 부채비율 < 50%: +15점 / 50~100%: +10점 / 100~200%: +5점 / 200% 이상: 0점
                    - 영업이익률 > 20%: +15점 / 10~20%: +10점 / 0~10%: +5점 / 적자: 0점
                    - 현재가가 52주 최고가 대비 20% 이상 하락: +15점 / 10~20% 하락: +10점 / 10% 미만 하락 또는 고점 근처: +3점
                    - 최신 뉴스 동향 호재 우세: +15점 / 중립: +8점 / 악재 우세: 0점
                    - 배당수익률 > 3%: +10점 / 1~3%: +5점 / 1% 미만: +2점
                    - 매출 성장률 > 15%: +10점 / 5~15%: +6점 / 0~5%: +3점 / 마이너스: 0점
                    ...
                    - 최신 뉴스 악재 강도 강함: +20점 / 중간: +10점 / 약함 또는 호재: 0점
                    ...
                    - Forward PER < 10: +25점 / 10~15: +18점 / 15~25: +8점 / 25 이상: 0점
                    - 52주 최고가 대비 현재가 20% 이상 하락 (반등 여력): +20점 / 10~20%: +12점 / 10% 미만: +3점
                    - 매출 성장률 > 20%: +20점 / 10~20%: +13점 / 0~10%: +6점 / 마이너스: 0점
                    - 최신 뉴스 호재 강도 강함: +20점 / 중간: +10점 / 약함 또는 악재: 0점
                    - 영업이익률 > 20%: +15점 / 10~20%: +10점 / 0~10%: +4점 / 적자: 0점
