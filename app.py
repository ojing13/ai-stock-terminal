...
<style>
    ...
    * {
    ...
    /* 1. 세로 나열 방지: 가로로 꽉 차면 줄바꿈 (flex-wrap) */
    ...
    /* 3. [왼쪽] 종목명 부분 (오른쪽 테두리 완전히 삭제, 둥근 모서리는 왼쪽만) */
...
if user_input:
    ...
    # 💥 한국 주식 휴일 에러 방지를 위해 5일치 데이터를 불러와 최신값을 사용합니다.
    try:
