        ...
        with tab1:
            ...
            if not filtered_history.empty:
                ...
                if interval_option == "일봉":
                    ma_settings = [(5, "단기 MA(5일)", "#00b0ff"), (20, "중기 MA(20일)", "#ff9100"), (60, "중장기 MA(60일)", "#ff4081"), (120, "장기 MA(120일)", "#aa00ff")]
                elif interval_option == "주봉":
                    ma_settings = [(5, "단기 MA(5주)", "#00b0ff"), (20, "중기 MA(20주)", "#ff9100"), (60, "중장기 MA(60주)", "#ff4081"), (120, "장기 MA(120주)", "#aa00ff")]
                else:
